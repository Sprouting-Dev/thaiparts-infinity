...
export interface ContactContactForm extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    showEmailField: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showMessageField: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    showNameField: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showPhoneField: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    showSubjectField: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    submitButtonText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Send'>;
    successMessage: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Thank you! Your message has been sent.'>;
...
export interface SectionsContactForm extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Contact form section configuration and settings';
    displayName: 'Contact Form';
  };
  attributes: {
    description: Schema.Attribute.Text;
    showEmailField: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    showMessageField: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    showNameField: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    showPhoneField: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface SectionsContactHero extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Hero section for contact page with title and subtitle';
...
export interface SectionsContactInfo extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Contact information section with address, phone, email, hours';
...
export interface SectionsContactMap extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Map section with iframe embed and location details';
  ...
  attributes: {
    allowFullscreen: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locationDescription: Schema.Attribute.Text;
    locationName: Schema.Attribute.String;
    mapHeight: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'400'>;
    mapIframeUrl: Schema.Attribute.Text & Schema.Attribute.Required;
    mapWidth: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'100%'>;
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Find Us'>;
  };
}
